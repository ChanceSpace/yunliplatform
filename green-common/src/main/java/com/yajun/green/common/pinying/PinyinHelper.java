package com.yajun.green.common.pinying;
...
public class PinyinHelper {
    ...
    public static void main(String[] args) throws Exception {
        String s = PinyinHelper.convertToPinyinString("你好中国 Nfeof", "", PinyinFormat.WITHOUT_TONE);
        String s1 = PinyinHelper.convertToPinyinString("你好中国", "", PinyinFormat.WITH_TONE_MARK);
        String s2 = PinyinHelper.convertToPinyinString("你好中国", "", PinyinFormat.WITH_TONE_NUMBER);
        System.out.println(s + "-" + s1 + s2);

        String ss = PinyinHelper.getShortPinyin("你好中国 Nfeof");
