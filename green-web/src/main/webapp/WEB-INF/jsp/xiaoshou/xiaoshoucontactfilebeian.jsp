...
<div >
    ...
    <%--合同条款部分--%>
    <form action="${pageContext.request.contextPath}/contact/xiaoshoucontactfilebeian.html" id="contact_file_form" name="basic_validate" novalidate="novalidate" class="layui-form" method="post"  enctype="multipart/form-data">
