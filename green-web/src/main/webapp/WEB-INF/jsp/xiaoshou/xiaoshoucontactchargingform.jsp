    ...
    <spring-form:form commandName="charging" id="charging_form" name="basic_validate" novalidate="novalidate" class="layui-form" method="post">
        ...
        <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label" for="xiaoShouContactChargingType">类型<i class="font_E60012">*</i></label>
                    <div class="layui-input-block">
                        <select name="xiaoShouContactChargingType">
                            <c:forEach items="${types}" var="loop">
                                <option value="${loop.value}" <c:if test="${loop.value == charging.xiaoShouContactChargingType}">selected="true"</c:if>>${loop.label} </option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
