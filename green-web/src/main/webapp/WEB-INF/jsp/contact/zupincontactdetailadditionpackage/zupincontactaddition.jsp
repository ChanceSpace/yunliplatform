                    ...
                    <div class="widget-box">
                        <div class="table-responsive col-md-12">
                            <table class="layui-table">
                                ...
                                <tbody>
                                <c:forEach var="contactFile" items="${zuPinContact.contactFiles}" varStatus="counter">
                                    <tr class="gradeX">
                                        <td>${counter.count}</td>
                                        ...
                                        <td align="center">
                                            <a href="${applicationHost}contact/${zuPinContact.contactNumber}/${contactFile.actualFileName}" target="_blank" class="layui-btn layui-btn-mini layui-btn-normal" style="margin-right:6px;vertical-align:middle;"><i class="layui-icon">&#xe625;</i>附件下载</a>
                                        </td>
                                    </tr>
                                </c:forEach>
...
<fieldset class="layui-elem-field">
    ...
    <yj:security grantRoles="ROLE_GREEN_CARRIER_RENT,ROLE_GREEN_ADMIN">
        <c:if test="${zuPinContact.contactStatus != 'S_FINISHED'}">
                        ...
                        <div class="table-responsive col-md-12">
                            <table class="layui-table">
                                ...
                                <tr>
                                    ...
                                    <th class="th_com" width="15%">操作</th>
                                </tr>
                                </thead>

                                <tbody>
                                <c:forEach var="charging" items="${zuPinContactChargings}" varStatus="counter">
                                    <tr class="gradeX">
                                        <c:if test="${charging.chargingCanBeEdit}" >
                                            ...
                                            <td>${charging.zuPinContactChargingTypeName}</td>
                                            <td>${charging.zuPinContactChargingStatusName}</td>
...
<fieldset class="layui-elem-field">
    ...
    <table class="layui-table" lay-skin="line">
        ...
        <tbody>
        <c:forEach var="contactLog" items="${zuPinContact.contactLogs}" varStatus="counter">
            <tr class="gradeX">
                <td>${counter.count}</td>
...
<script type="text/javascript">
    ...
    function openContactFilePopup() {
        settings.source = '${pageContext.request.contextPath}/contact/zupincontactfilebeian.html?zuPinContactUuid=${zuPinContact.uuid}'
    ...
    function changeZuPinContactChargingStatus(chargingUuid) {
        layer.confirm('请确认是否已处理该充电桩？', {
            ...
            layer.close(index);
            window.location.href='${pageContext.request.contextPath}/contact/zupincontactchargingstatus.html?chargingUuid=' + chargingUuid + '&zuPinContactUuid=' + '${zuPinContact.uuid}';
        });
    }
    ...
    function oPenChargingPopup(chargingUuid) {
        settings.source ='${pageContext.request.contextPath}/contact/zupincontactchargingform.html?chargingUuid=' + chargingUuid + '&zuPinContactUuid=${zuPinContact.uuid}' ;
        openModalPopup(settings);
    }
    //删除充电桩信息
    function deleteZuPinContactChargingModal(chargingUuid) {
        ...
        layer.confirm('请确认是否删除该充电桩信息？', {
            ...
            layer.close(index);
            window.location.href = '${pageContext.request.contextPath}/contact/zupincontactchargingdelete.html?chargingUuid=' + selectContactChargingUuid + '&zuPinContactUuid=${zuPinContact.uuid}';
        });
    }
</script>