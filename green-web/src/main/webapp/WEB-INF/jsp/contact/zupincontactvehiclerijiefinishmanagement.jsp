...
<div>
    ...
    <yj:security grantRoles="ROLE_GREEN_CARRIER">
        <yj:security grantRoles="ROLE_GREEN_CARRIER">
            <div class="scum_nav">当前位置：<a href="${pageContext.request.contextPath}/contact/zupincontactdetails.html?zuPinContactUuid=${zuPinContactUuid}" class="font_33a7fd">合同详情</a><img src="${pageContext.request.contextPath}/build/images/arrow_right.png" width="10">车辆结束</div>
        </yj:security>
    </yj:security>
