...
<div  style="margin:20px;">
    ...
    <fieldset class="layui-elem-field">
                ...
                <fieldset class="layui-elem-field">
                    <div class="layui-field-box">
                        <table class="site-table table-hover">
                            ...
                            <tbody>
                                <c:forEach var="zuPinContactSupplyContents" items="${zuPinContactSupplyDTO.zuPinContactSupplyContentDTOS}"  varStatus="counter">
                                    <tr class="gradeX">
                                        <td>${counter.count}</td>
                                        <td>${zuPinContactSupplyContents.content}</td>

                                        <td class="center">
                                            <a href="javascript:void(0);" onclick="deleteZuPinContactSupplyModal('${zuPinContactSupplyContents.uuid}')" data-id="1" data-opt="del" class="layui-btn layui-btn-danger layui-btn-mini"><i class="layui-icon">&#xe640;</i>删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
        ...
        <spring-form:form commandName="zuPinContactSupplyContentDTO" id="contact_buchong_form" name="basic_validate" novalidate="novalidate" class="layui-form" method="post">
            <input type="hidden" name="zuPinContactUuid" value="${zuPinContactUuid}"/>
            <input type="hidden" name="zuPinContactSupplyUuid"  value="${zuPinContactSupplyDTO.uuid}"/>
...
<script type="text/javascript">
    ...
    function deleteZuPinContactSupplyModal(contactSupplyUuid) {
        layer.confirm('请确认是否删除该补充协议条款？', {
            ...
            layer.close(index);
            window.location.href = '${pageContext.request.contextPath}/contact/zupincontactsupplycontentdelete.html?contactSupplyUuid=' + contactSupplyUuid + '&zuPinContactUuid=${zuPinContactUuid}&contctSupplyContentId=${zuPinContactSupplyDTO.uuid}';
       });
    }

    //    添加补充协议内容
    function openZuPinContactSupplyContent(contactSupplyUuid) {
        window.location.href = '${pageContext.request.contextPath}/contact/zupincontactsupplycontentform2.html?contactSupplyUuid=' + contactSupplyUuid + '&zuPinContactUuid=${zuPinContact.uuid}';
    }
</script>
</body>
</html>
