...
<body>
<div>
    <spring-form:form id="carrierBalanceForm" name="basic_validate" commandName="carrierBalanceHistory" class="layui-form" action="${pageContext.request.contextPath}/carrier/carrierbalancetixian.html" method="post" enctype="multipart/form-data">
        ...
        <fieldset class="layui-elem-field">
            <legend>
                    <i class="layui-icon" style="color:#009900;font-size:22px;">&#xe63c;</i>&nbsp;余额提现
            </legend>
            <div class="layui-field-box">

                <div class="layui-form-item">
                        <label class="layui-form-label">提现金额<i class="font_E60012">*</i></label>
                    <div class="layui-input-block">
                        ...
                        <label id="feeTotal_help" class="error" style="display: none; color: red;">提示:提现金额不能为空，且必须为数字</label>
                        <label id="feeTotal_help1" class="error" style="display: none; color: red;">提示:提现金额不能超过账户余额</label>
                        <label id="feeTotal_help2" class="error" style="display: none; color: red;">提示:提现金额不能为0</label>
                    </div>
                </div>

                <div class="layui-form-item">
                        <label class="layui-form-label">提现日期<i class="font_E60012">*</i></label>
                    <div class="layui-input-block">
                        <input id="happendDate" name="happendDate" class="datepicker layui-input" value="${today}"/>
                        <label id="happendDate_help" class="error" style="display: none; color: red;">提示:提现日期有误</label>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="jiaoYiNumber" name="jiaoYiNumber" class="layui-input" maxlength="48  " placeholder="请输入提现凭证的单据编号" />
     ...
     <div class="layui-form-item" style="text-align: center">
            <button class="layui-btn" onclick="saveCarrierBalanceTiXianConfirm();">确认</button>
