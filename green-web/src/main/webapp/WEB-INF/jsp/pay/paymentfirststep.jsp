    ...
    <div class="pay_con">
        ...
        <div class="layui-row">
            ...
            <c:if test="${totalFee >= 0}">
                ...
                <%--<div class="layui-col-md3">--%>
                    <%--<div class="online_list" data-id="O_YINLIAN">--%>
                        <%--<img src="${pageContext.request.contextPath}/build/images/xianshang.png" width="120" />--%>
                    <%--</div>--%>
                <%--</div>--%>
        ...
        <form id="payment_form" class="lineDown layui-form" action="${pageContext.request.contextPath}/carrier/paymentonlinefirst.html" <c:if test="${totalFee >= 0}"> style="display:none;" </c:if> method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    layui.use('jquery', function() {
        ...
        $(".online_list").on("click", function() {
            ...
            /*if(self.hasClass("yue_pay")&&${totalFee <= chengYun.currentBalance}) {
                $(".lineDown").show();
            } else if(self.hasClass("yue_pay")&&${totalFee > chengYun.currentBalance}) {
                $(".lineDown").hide();
                $(".pay_btn").hide();
            }else {
                $(".lineDown").hide();
        ...
        if(validate) {
            ...
            btn : [ '确定', '取消' ]//按钮
                ...
                if('O_OFFLINE' == orderWay) {
                    jQuery("#payment_form").attr('action', context + '/carrier/paymentoffline.html');
                } else {
                    jQuery("#payment_form").attr('action', context + '/carrier/paymentonlinefirst.html');
                }
