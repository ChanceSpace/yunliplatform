...
<script type="text/javascript">
    ...
    function updatePaymentStatus() {
         $.ajax({
            type : "POST",
            url : '${pageContext.request.contextPath}/carrier/paymentonlinesecond.html?payOrderNumber=${payOrderNumber}',
            ...
            success : function(result) {
                ...
                if('YES' == flag) {
                    ...
                    window.location.href = '${pageContext.request.contextPath}/carrier/paymentfinish.html?payOrderNumber=${payOrderNumber}&jiaoYiNumber=' + jiaoYiNumber + '&totalFee=' + totalFee;
                } if('NO' == flag) {
                    window.location.href = '${pageContext.request.contextPath}/carrier/paymenterror.html';
                }
            }
        });
    ...
    function finishWaiting() {
        window.location.href = '${pageContext.request.contextPath}/carrier/paymentonlinefinishwaiting.html?payOrderNumber=${payOrderNumber}';
    }

    /*****************************************测试部分**********************************************/

    function testOnlinePayOrder() {
        window.location.href = '${pageContext.request.contextPath}/carrier/paymentonlinesecondfake.html?payOrderNumber=${payOrderNumber}&jiaoYiNumber=TESTTESTTEST';
    }
</script>
