 ...
 */
public class XiaoShouContactForCarrierOverviewPaging extends AbstractPaging<ZuPinXiaoShouContactDTO> {
    ...
    public XiaoShouContactForCarrierOverviewPaging(XiaoShouContactForCarrierService xiaoShouContactForCarrierService) {
        this.xiaoShouContactForCarrierService = xiaoShouContactForCarrierService;
    }

    @Override
    public List<ZuPinXiaoShouContactDTO> getItems() {
        return xiaoShouContactForCarrierService.obtainOverviewXiaoShouContact(keyWords, userUuid, startTime, endTime, sortBy, sortWay, contactStatus, getStartPosition(), getPageSize());
    }
    ...
    public long getTotalItemSize() {
        ...
        totalItemSize = xiaoShouContactForCarrierService.obtainOverviewXiaoShouContactSize(keyWords, userUuid, startTime, endTime, sortBy, sortWay, contactStatus);
